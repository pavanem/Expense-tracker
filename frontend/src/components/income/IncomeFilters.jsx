...
export default function IncomeFilters({ incomeCategories, filters, onChange, onClear, activeCount }) {
  ...
  return (
    <Stack spacing={1.5} sx={{ mb: 2 }}>
      <TextField
        placeholder="Search by category, source, description, amount, date"
      ...
      >
        ...
        <AccordionDetails>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={9} sx={{ display: 'flex', alignItems: 'center', justifyContent: { xs: 'flex-start', md: 'flex-end' } }}>
